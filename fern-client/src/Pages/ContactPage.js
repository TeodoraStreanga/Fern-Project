        ...
        <div className = "contact-block">
          ...
          <ul className ="contact-text">
            ...
            <li className = "contact-item">
              ...
              <span>Субота - Неділя, 8:00 AM - 20:00 PM</span>
            </li>
            <li className = "contact-item">
